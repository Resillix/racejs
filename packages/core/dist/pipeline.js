 ...
 */
export async function runPipeline(req, res, handlers, errorHandler) {
 ...
 */
export function runPipelineSync(req, res, handlers, errorHandler) {
    const ctx = {
        req,
        res,
        handlers,
 ...
 */
export function runHooks(hooks, ...args) {
