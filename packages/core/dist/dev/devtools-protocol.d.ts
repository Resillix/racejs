...
export type ServerMessage = ConnectedMessage | MetricsUpdateMessage | RoutesListMessage | RequestRecordedMessage | RequestResponseMessage | RequestsListMessage | {
    type: ServerMessageType.REQUEST_DETAILS;
    timestamp: number;
    id: string;
    data: any;
} | {
    type: ServerMessageType.REQUESTS_EXPORT;
    timestamp: number;
    id: string;
    data: {
        data: any;
    };
} | LogEntryMessage | PerformanceUpdateMessage | ReplayResultMessage | ReplayComparisonMessage | TestGeneratedMessage | ErrorTrackedMessage | ErrorListMessage | ErrorDetailsMessage | ErrorStatsMessage | ErrorSpikeAlertMessage | ErrorMessage;
/**
 * Client messages
 */
...
export type ClientMessage = HelloMessage | PingMessage | GetMetricsMessage | GetRoutesMessage | GetRequestsMessage | GetRequestMessage | ClearRequestsMessage | DeleteRequestMessage | ExportRequestsMessage | GetLogsMessage | ClearLogsMessage | GetPerformanceMessage | GetPerformanceMetricsMessage | StartProfilingMessage | StopProfilingMessage | ReplayRequestMessage | CompareResponsesMessage | GenerateTestMessage | EditAndReplayMessage | GetErrorsMessage | GetErrorDetailsMessage | GetErrorStatsMessage | MarkErrorResolvedMessage | MarkErrorIgnoredMessage | ClearErrorsMessage | ExportErrorsMessage;
/**
 * Helper to create server messages
 */
export declare function createServerMessage<T extends ServerMessage>(type: ServerMessageType, data: any): T;
/**
 * Helper to create client messages
 */
export declare function createClientMessage<T extends ClientMessage>(type: ClientMessageType, data?: any): T;
