...
export class DevToolsServer extends EventEmitter {
    ...
    async stop() {
        ...
        for (const client of this.clients) {
            try {
                ...
                client.send(JSON.stringify(createServerMessage('shutdown', {
    ...
    flushMessageQueue(client) {
        ...
        if (remaining.length > 0) {
            ...
            const delay = client.rateWindowStart && nextNow - client.rateWindowStart < 1000
    ...
    handleConnection(ws) {
        ...
        this.send(ws, createServerMessage('connected', {
    ...
    handleMessage(data, client) {
        try {
            ...
            if (message.type === ClientMessageType.PING) {
                this.send(client, createServerMessage(ServerMessageType.PONG, {
                    timestamp: Date.now(),
            ...
            this.send(client, createServerMessage('error', {
