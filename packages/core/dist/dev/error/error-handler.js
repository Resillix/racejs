...
export class DevErrorHandler extends EventEmitter {
     ...
     */
    async enhance(error, req) {
        // Check if error already has EnhancedError properties
        const existingEnhanced = error;
    ...
    async sendErrorResponse(error, res) {
        ...
        console.log('[DevErrorHandler] sendErrorResponse - shouldShowDetails:', this.shouldShowDetails());
        console.log('[DevErrorHandler] sendErrorResponse - enabled:', this.options.enabled);
        console.log('[DevErrorHandler] sendErrorResponse - showErrorDetails:', this.options.showErrorDetails);
     ...
     */
    addBreadcrumb(requestId, breadcrumb) {
